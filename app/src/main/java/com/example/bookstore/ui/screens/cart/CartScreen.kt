...
fun CompactCartScreenPreview() {
    BookStoreTheme {
        CartScreen(navigationType = NavigationType.BOTTOM_NAVIGATION)
    }
}
...
fun MediumCartScreenPreview() {
    BookStoreTheme {
        CartScreen(navigationType = NavigationType.NAVIGATION_RAIL)
    }
}
...
fun ExpandedCartScreenPreview() {
    BookStoreTheme {
        CartScreen(navigationType = NavigationType.PERMANENT_NAVIGATION_DRAWER)
    }
}