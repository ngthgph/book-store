...
fun CompactFavoriteScreenPreview() {
    BookStoreTheme {
        FavoriteScreen(navigationType = NavigationType.BOTTOM_NAVIGATION, onIconClick = {})
    }
}
...
fun MediumFavoriteScreenPreview() {
    BookStoreTheme {
        FavoriteScreen(navigationType = NavigationType.NAVIGATION_RAIL, onIconClick = {})
    }
}
...
fun ExpandedFavoriteScreenPreview() {
    BookStoreTheme {
        FavoriteScreen(navigationType = NavigationType.PERMANENT_NAVIGATION_DRAWER, onIconClick = {})
    }
}